            ...
            <div class="col-lg-3 mt-5">
                <div class="custom-card2">
                    ...
                    <div class="mt-4 text-end">
                        <button id="buttonalert1" class="btn btn-yellow">ตกลง</button>
                    </div>
                </div>
            </div>
        ...
        <div class="container mt-5">
                ...
                <div style="padding: 50px;">
                    <div class="text-center">
                        ...
                        <div id="output" class="mt-4 hide">
                            <h2>Hello, <input class="form-control-lg bg-dark border border-secondary rounded rounded-3 text-white" id="textoutput"> <span id="textoutput2"></span></h2>
                        </div>
                        <div class="mt-2">
                            <b id="xss"></b>
                        </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-6 text-end">
                    <a href="../3/" id="nextlevel" class="btn btn-dark text-secondary disabled" style="font-size: 20px;">LEVEL THREE <i style="padding-left: 5px;" class="fa-solid fa-circle-arrow-right"></i></a>
                </div>
            </div>
        </div>
