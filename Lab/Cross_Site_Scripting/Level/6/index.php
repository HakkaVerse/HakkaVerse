        ...
        <div class="container mt-5">
            <div class="custom-card">
                <div style="padding: 50px;">
                    <div class="text-center">
                        <p>ใส่ที่มารูปภาพของคุณ</p>
                        <div class="mt-4">
                            <center><input style="width: 400px;" id="input" value=" /images/hack.jpg" autocomplete="off" class="form-control form-control-lg bg-dark text-white text-center border-secondary border-top" placeholder="ใส่ชื่อของคุณ"></center>
                        </div>
                        <div class="mt-4">
                        ...
                        <div id="win" class="mt-5 hide">
                            <p style="font-size: 20px;">ยินดีด้วยครับบบบ ตอนนี้คุณผ่านครับทั้ง 6 เลเวลแล้วว !!</p>
                            <input class="mt-2 form-control-lg text-center bg-dark text-warning border" disabled value="HKA(XSS_MASTER)">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                ...
                <div class="col-lg-6 text-end">
                    <a href="../../" id="nextlevel" class="btn btn-dark text-secondary disabled" style="font-size: 20px;">กลับสู่หน้าหลัก <i style="padding-left: 5px;" class="fa-solid fa-circle-arrow-right"></i></a>
                </div>
            </div>
        </div>
