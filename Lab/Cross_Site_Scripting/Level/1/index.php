        ...
        <div class="container mt-5">
            <div class="custom-card">
                <div style="padding: 50px;">
                    <div class="text-center">
                        <p>ใส่ชื่อของคุณ</p>
                        <div class="mt-4">
                            <center><input style="width: 400px;" id="input" autocomplete="off"
                                    class="form-control form-control-lg bg-dark text-white text-center border-secondary border-top"
                                    placeholder="ใส่ชื่อของคุณ"></center>
                        </div>
                        <div class="mt-4">
                            <button class="btn btn-orange text-white" id="confirm">ยืนยันคำตอบ</button>
                        </div>
                        <div id="output" class="mt-4 hide">
                            <h2>Hello, <span id="textoutput"></span></h2>
                        </div>
                        <div class="mt-2">
                            <b id="xss"></b>
                        </div>
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-6 text-end">
                    <a href="../2/" id="nextlevel" class="btn btn-dark text-secondary disabled"
