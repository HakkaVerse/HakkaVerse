...
<body>
    ...
    <div class="h3"><span><b>สวัสดีครับทุกท่านน !!</b> ขอต้อนรับเข้าสู่ <b>Lab</b> ของ <b> SQL Injection</b>
            นะครับ</span>
    </div>
    ...
    <a class="next" href="../Security/"><img src="../../public/img/icon/next.png"></a>
    <a class="back" href="../Cross_Site_Scripting/"><img src="../../public/img/icon/back.png"></a>
    <style>
    .next {
        position: absolute;
        width: 55px;
