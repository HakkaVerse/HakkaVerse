          ...
          <div class="col-lg-4 text-white mt-5">
            <div class="mt-5"></div>
              ...
              <input type="hidden" name="reset_password" value="true">
                ...
                <div class="mt-2">
                    <input class="input" name="email" autocomplete="off" type="email" required placeholder="อีเมล....">
                </div>
                <div class="mt-4">
                    <button type="submit" class="btn btn-gradient-login btn-glow-login" style="width:55%; border-radius: 10px;">เปลี่ยนรหัสผ่าน</button>
                </div>
