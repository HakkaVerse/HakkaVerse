        ...
        <center>
            ...
            <center>
                <div class="card text-center" style="border-radius: 20px; width: 18rem;">
                    ...
                    <div>
                        <a style="width: 95%;"
                            class="btn btn-custom btn-glow mt-2"><?php echo account()->getNickName(); ?></a>
                    </div>
                    <div class="mt-2"></div>
                </div>
            </center>
...
font-size: 20px; letter-spacing: 1px; text-shadow: none;" class="btn btn-custom mt-2"><?php echo account()->getNickName(); ?></a>
