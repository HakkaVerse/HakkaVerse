    ...
    <div class="row" style="padding: 50px;">
        ...
        <div class="col-lg-8 mt-5 text-white">
            <div style="padding-left:18px;">
                ...
                src="link"
                -->
                <img src="https://cdn.discordapp.com/attachments/878242783947784234/977909538294497320/C2A6A1CC-C1BC-4466-94EF-AD9D2F6B9F8D.jpg"
                    style="border-radius: 50%; width: 80px; height: 80px; object-fit: cover;">
                <span style="padding-left: 19px;position: absolute; padding-top: 55px;"><b style="color: white;">By</b>
                    Aem Supachai</span>
                <div class="mt-5">
                    <h3><b style="color: white;">Web Security</b></h3>
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    ...
                    <a href="Download/WEB SECURITY REPORT.pdf" download><button style="width: 230px; left:30px;"
        ...
        <div class="col-lg-6" style="position: relative; bottom: 200px; right:80px;">
            <a href="?testlist=2"><img width="40px" src="../../public/img/icon/back.png"></a>
        </div>
        <div class="col-lg-6 text-end" style="position: relative; bottom: 200px; left:80px;"">
            <a href=" ?testlist=1"><img width="40px" src="../../public/img/icon/next.png"></a>
        </div>
